export const statusLabels = { ABERTO: 'Aberto', EM_ATENDIMENTO: 'Em atendimento', CONCLUIDO: 'Concluído' };
export const categoryLabels = { acesso: 'Acesso e contas', hardware: 'Equipamentos', software: 'Software', rede: 'Rede e conexão', outros: 'Outros' };
...
export function formatDate(value, short = false) {
  ...
  return new Intl.DateTimeFormat('pt-BR', { dateStyle: short ? 'short' : 'medium', ...(short ? {} : { timeStyle: 'short' }) }).format(date);
}
